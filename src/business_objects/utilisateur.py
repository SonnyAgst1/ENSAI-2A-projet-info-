...
class Utilisateur: 
    ...
    def __str__(self):
        ...
        return f"{self._pseudo} ({self._prenom} {self._nom}) - {len(self._liste_activites)} activités"
    
    def __repr__(self):
        """Représentation technique de l'utilisateur"""
        return f"Utilisateur(id={self._id_utilisateur}, pseudo={self._pseudo}, activites={len(self._liste_activites)})"
