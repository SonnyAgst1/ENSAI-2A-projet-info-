class Commentaire:
    ...
    def __str__(self):
        ...
        return f"Commentaire #{self._id} par {self._auteur.pseudo}: {self._contenu[:50]}... ({self.comptelike()} likes)"
    
    def __repr__(self):
        """Représentation technique du commentaire"""
        return f"Commentaire(id={self._id}, auteur={self._auteur.pseudo}, likes={self.comptelike()})"
...
if __name__ == "__main__":
    ...
    com1 = Commentaire(1, user1, activite1, "Super séance aujourd'hui ! J'ai battu mon record personnel.")
